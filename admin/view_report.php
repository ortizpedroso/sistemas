        ...
        <div class="col-md-10 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <a href="all_reports.php" class="btn btn-secondary">Voltar para Todas as Denúncias</a>
                        <a href="edit_report.php?id=<?php echo $report['id']; ?>" class="btn btn-warning">Editar Status</a>
                    </div>
                </div>
            </div>
        </div>
